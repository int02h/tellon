...
public class NotifyCommand extends Command {
    ...
    public void execute(final CommandContext context) throws CommandExecutionException {
        ...
        if (walkers.isEmpty()) {
            throw new CommandExecutionException("No project walker found");
        }
        ...
        if (arguments.getProjectWalkerName() != null) {
            ...
            if (walkers.size() == 1) {
                ...
                throw new CommandExecutionException("More than one project walkers found. Choose one of them.");
            }
        }
        ...
        try {
            ...
            throw new CommandExecutionException("Fail to initialize project walker", e);
        }

        final List<ChangesNotifier> notifiers = context.getNotifiers();
        if (notifiers.isEmpty()) {
            throw new CommandExecutionException("No changes notifier found");
        }
        ...
        for (ChangesNotifier notifier : notifiers) {
            try {
                ...
                throw new CommandExecutionException("Fail to initialize notifier " + notifier.getName(), e);
            }
        }
        ...
        try {
            ...
            throw new CommandExecutionException("Fail to notify", e);
        }
    }
